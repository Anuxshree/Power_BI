...
def send_feedback(feedback):
    ...
    receiver_email = "anushreethangavel@gmail.com"
...
def home_page():
    st.markdown(
        """
        <h1 style="font-size: 36px; color: black;">Welcome to the Indian GDP and Productivity Analysis Dashboard</h1>
        """, 
        unsafe_allow_html=True
    )
    ...
    st.write("""
            ...
            - **Comprehensive Economic Analysis**: Our dashboard covers GDP, inflation rates, employment figures, and other indicators to give you a holistic view.
...
def about_page():
    ...
    - **Navigation System**: Sidebar navigation for easy access.
    """)

    st.subheader("Technical Stack:")
    st.write("""
    - **Frontend**: Built using Streamlit, enhanced with custom CSS for styling.
    - **Backend**: SMTP integration for feedback emails.
    ...
    - **Students/Researchers**: Access visualized data for academic research.
